    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedId = ((String) evaluateAndTransform(getMuleContext(), event, DeleteUserMessageProcessor.class.getDeclaredField("_idType").getGenericType(), null, id));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((PagerDutyConnector) object).deleteUser(_transformedId);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at PagerDutyConnector at deleteUser retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
