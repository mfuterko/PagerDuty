    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((PagerDutyConnector) object).addEntity(_transformedKey, _transformedEntity);
                }
    ...
    public Result<MetaData> getInputMetaData() {
        if (((key) == null)||((key).toString() == null)) {
            return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error retrieving metadata from parameter: key at processor addEntity at module PagerDutyConnector");
        }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at PagerDutyConnector at addEntity retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
