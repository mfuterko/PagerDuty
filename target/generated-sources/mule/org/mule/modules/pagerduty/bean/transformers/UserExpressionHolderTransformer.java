    ...
    implements DiscoverableTransformer, MessageTransformer
{
        ...
        throws TransformerMessagingException
    {
        ...
        try {
            final String _transformedMember_order = ((String) evaluateAndTransform(this.muleContext, event, UserExpressionHolder.class.getDeclaredField("_member_orderType").getGenericType(), null, holder.getMember_order()));
            result.setMember_order(_transformedMember_order);
            final User _transformedUser = ((User) evaluateAndTransform(this.muleContext, event, UserExpressionHolder.class.getDeclaredField("_userType").getGenericType(), null, holder.getUser()));
