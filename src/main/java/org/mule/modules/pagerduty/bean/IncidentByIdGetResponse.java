...
/**
 * The Class IncidentByIdGetResponse.
 */
...
public class IncidentByIdGetResponse extends StatusResponse {
    ...
    /** The number_of_escalations. */
    private String number_of_escalations;
    
    /** The resolved_by_user. */
    private User resolved_by_user;

    /**
     * Gets the resolved_by_user.
     *
     * @return the resolved_by_user
     */
	...
	/**
	 * Sets the resolved_by_user.
	 *
	 * @param resolved_by_user the new resolved_by_user
	 */
	...
	/**
	 * Gets the number_of_escalations.
	 *
	 * @return the number_of_escalations
	 */
	...
	/**
	 * Sets the number_of_escalations.
	 *
	 * @param number_of_escalations the new number_of_escalations
	 */
    ...
    {
        return "ClassPojo [assigned_to = "+assigned_to+", html_url = "+html_url+", id = "+id+", assigned_to_user = "+assigned_to_user+", last_status_change_on = "+last_status_change_on+", status = "+status+", created_on = "+created_on+", last_status_change_by = "+last_status_change_by+", service = "+service+", incident_key = "+incident_key+", trigger_summary_data = "+trigger_summary_data+", pending_actions = "+pending_actions+", incident_number = "+incident_number+", trigger_details_html_url = "+trigger_details_html_url+", urgency = "+urgency+"]";
    }
