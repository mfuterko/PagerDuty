...
/**
 * The Class Maintenance_windows.
 */
public class Maintenance_windows {
    ...
    {
        return "ClassPojo [created_by = "+created_by+", sequence_number = "+sequence_number+", id = "+id+", teams = "+teams+", services = "+services+", end_time = "+end_time+", description = "+description+", start_time = "+start_time+"]";
    }
