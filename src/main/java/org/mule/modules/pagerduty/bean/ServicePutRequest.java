...
public class ServicePutRequest {
	 ...
	 *
	 * @param acknowledgment_timeout the new acknowledgment_timeout
	 */
	public void setAcknowledgment_timeout(int acknowledgment_timeout) {
		this.acknowledgment_timeout = acknowledgment_timeout;
	}
